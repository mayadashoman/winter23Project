...
public class chat_provider extends AppCompatActivity {
    int prov_id,u_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat_provider);
    ...
    {
        ListView lv = (ListView) findViewById(R.id.prov_Chat_list);
        adap = new Adapter_chat(this, logs);
        lv.setAdapter(adap);
    }


    public void prov_send_logs(View v)
    {

       send_Chat_API send_ch = new send_Chat_API();
        TextView tv = (TextView) findViewById(R.id.prov_text_chat);
    ...
    private class send_Chat_API extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... strings) {
            String myData = "null";
            try {
                String url = new String("http://10.0.2.2:3000/sendchat_p?u_id="+strings[0]+"&p_id="+strings[1]+"&body="+strings[2].replace(" ","%20"));
