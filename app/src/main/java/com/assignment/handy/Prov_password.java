...
public class Prov_password extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prov_password);
    ...
    public void change_pass(View v)
    {
       ...
       Get_Pass_API getpass = new Get_Pass_API();
        getpass.execute(String.valueOf(p_id));
    }
    public void check(String pass)
    {
        ...
        if(pass.equals(password))
        {
            ...
            if(new_password.equals(confirm_password))
            {
                ...
                update_pass.execute(String.valueOf(p_id),new_password);
            }
            else
            {
    ...
    private class Get_Pass_API extends AsyncTask<String, String, JSONArray> {
        ...
        protected JSONArray doInBackground(String... strings) {
            String myData = "null";
            try {
                String url = new String("http://10.0.2.2:3000/getprov_id?id="+strings[0]);
    ...
    private class Update_Pass_API extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... strings) {
            String myData = "null";
            try {
                String url = new String("http://10.0.2.2:3000/setpass_p?id="+strings[0]+"&password="+strings[1]);
